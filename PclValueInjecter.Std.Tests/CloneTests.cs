...
namespace Xciles.PclValueInjecter.Tests
{
    public class CloneTests
    {
        ...
        public void Test()
        {
            ...
            f1.InjectFrom(f);
            Assert.Equal(f1.Fox, f.Fox);

            f1.InjectFrom<CloneInjection>(f);

            Assert.NotEqual(f1.Fox, f.Fox);
            Assert.NotEqual(f1.Fox.Fox, f.Fox.Fox);
            Assert.Equal(f1.Fox.Name, f.Fox.Name);
            Assert.Equal(f1.Fox.Fox.Name, f.Fox.Fox.Name);
