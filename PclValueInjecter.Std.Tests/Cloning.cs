...
namespace Xciles.PclValueInjecter.Tests
{
    public class Cloning
    {
        ...
        public void Test()
        {
            ...
            Assert.Equal(o.NullInt, c.NullInt);
            Assert.Equal(o.IntArr, c.IntArr);
            Assert.Equal(o.Ints, c.Ints);

            Assert.NotEqual(o.F1, c.F1);
            Assert.NotEqual(o.Foos, c.Foos);
            Assert.NotEqual(o.FooArr, c.FooArr);

            //Foo F1
            Assert.Equal(o.F1.Name, c.F1.Name);

            //Foo[] FooArr
            Assert.Equal(o.FooArr.Length, c.FooArr.Length);
            Assert.NotEqual(o.FooArr[0], c.FooArr[0]);
            Assert.Equal(o.FooArr[0].Name, c.FooArr[0].Name);

            //IEnumerable<Foo> Foos
            Assert.Equal(o.Foos.Count(), c.Foos.Count());
            Assert.NotEqual(o.Foos.First(), c.Foos.First());
            Assert.Equal(o.Foos.First().Name, c.Foos.First().Name);
        }
